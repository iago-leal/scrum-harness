...
const actionSchema = z.discriminatedUnion('action', [
  ...
  z.object({ action: z.literal('updateItem'), id: z.string(), title: z.string().optional(), description: z.string().optional(), estimate: z.number().nonnegative().optional(), targetDate: z.string().optional(), status: z.string().optional(), goal: z.string().optional() }),
  z.object({ action: z.literal('deleteItem'), id: z.string(), cascade: z.boolean().optional() }),
  z.object({ action: z.literal('planSprint'), goal: z.string().min(1), startDate: z.string().optional(), endDate: z.string().optional(), taskIds: z.array(z.string()).optional() }),
