 ...
 * Moved from `tool-scrum/src/probe.ts` in v0.24 (comp-59 R4) so the command
 * and the API can share it; that path stays as a re-export shim.
 * @module @scrum-harness/probe/files
 */
